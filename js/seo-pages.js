(() => {
  ...
  const aboutEntries = [
    ...
    ['Мы находимся здесь — в Алматы.', 'We are based here — in Almaty.'],
    ['Карта Казахстана с отметкой Алматы', 'Map of Kazakhstan with Almaty marked'],
    ['Мы здесь · Алматы', 'We are here · Almaty'],
